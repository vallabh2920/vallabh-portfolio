  ...
  return (
    <div id="projects">
      ...
      <div className="ml-24 mr-24 mt-10 mb-14 p-11 flex justify-center items-center flex-col  bg-first rounded-xl md:mx-7">
        <a
          href="https://foodies-b9b87.web.app/"
          alt=""
          target="_blank"
        ...
        <p className=" text-2xl text-fourth">
          Designed and Developed the Website about food and calories.
        </p>
        <br></br>
        <p className=" text-2xl font-semibold text-third">
          Features implemented:-{" "}
        </p>
        <ul className="list-disc ml-4 mt-4 space-y-4 text-2xl text-fourth">
          <li>
            Implemented adaptive way to make responsive website with different
            view
          </li>
          <li>
            Built with reactjs and using and Food recipe API provided by
            edamam.com
          </li>
        </ul>
      </div>
